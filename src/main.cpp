		...
		if (length && length > 2 && data[0] == '4' && data[1] == '2')
		{
			...
			if (s != "") {
				...
				if (event == "telemetry") {
					...
					for (int i = 0; i < static_cast<int>(x_sense.size()); i++)
					{
						LandmarkObs obs;
						obs.x = x_sense[i];
						obs.y = y_sense[i];
					...
					// Since I am reassigning the weight to 1.0 to all the resampled particles. I does'nt matter to print this value.
					//cout << setprecision(9) << "highest w " << highest_weight << endl;
					//cout << setprecision(9) << "average w " << weight_sum / num_particles << endl;
